...
void siuu(){
    ...
    fl(0,n){
        cin >> v[i];
        if(v[i]%3==0)mp3[v[i]/3]++;
    
        if(v[i]%7==0)mp7[v[i]/7]++;
        if(v[i]%5==0){
            ansi+= mp3[v[i]/5]*mp7[v[i]/5];
            //cout << i+1 <<' '<< v[i]/5<<' '<<mp3[v[i]/5]<<' '<<mp7[v[i]/5]<< endl;
        }
    ...
    fl(0,n){
        ...
        if(v[i]%7==0)mp7[v[i]/7]++;
        if(v[i]%5==0)ansi+= mp3[v[i]/5]*mp7[v[i]/5];
        //cout << i+1 <<' '<< v[i]/5<<' '<<mp3[v[i]/5]<<' '<<mp7[v[i]/5]<< endl;
    }
